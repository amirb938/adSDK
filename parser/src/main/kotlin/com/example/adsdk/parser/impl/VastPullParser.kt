package com.example.adsdk.parser.impl

import com.example.adsdk.parser.VastParser
import com.example.adsdk.parser.VastWrapperFetcher
import com.example.adsdk.parser.error.VastParseError
import com.example.adsdk.parser.error.XmlParseError
import com.example.adsdk.parser.internal.attr
import com.example.adsdk.parser.internal.parseVastTimeToMs
import com.example.adsdk.parser.internal.readText
import com.example.adsdk.parser.internal.skipTag
import com.example.adsdk.parser.internal.toIntOrNullSafe
import com.example.adsdk.parser.model.MediaFile
import com.example.adsdk.parser.model.SkipOffset
...
class VastPullParser(
    ...
    override fun parse(xml: String, wrapperFetcher: VastWrapperFetcher?): List<VastAd> {
